...
//============================================================================
{
  ...
  histoTools_.BookHisto_1D(hCalo_ResolutionPhi_1pr         , "Calo_ResolautionPhi_1pr"        , ";#delta #phi / #phi^{vis};Events / %.2f rads" , 2000, -10.0, +10.0);
  ...
  histoTools_.BookHisto_1D(hCaloIso_ResolutionPhi_1pr         , "CaloIso_ResolautionPhi_1pr"        , ";#delta #phi / #phi^{vis};Events / %.2f rads" , 2000, -10.0, +10.0);
