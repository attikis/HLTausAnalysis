...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
#include "../TkTaus.C+" // how to compile macro in ROOT6 (compatible with ROOT5 as well)
//#include <TROOT.h>
#include <TError.h>
	 ...
	 const int maxEvents = -1)
{
  ...
  // TkTaus macro(absolutePath + "/" + MulticrabDir, SampleName, text, maxEvents);

  // Suppress ROOT warnings (https://root-forum.cern.ch/t/gerrorignorelevel-problem/13178/3)
  gErrorIgnoreLevel = kFatal; 

  TkTaus macro(MulticrabDir, SampleName, text, maxEvents);
  macro.Loop();
}
