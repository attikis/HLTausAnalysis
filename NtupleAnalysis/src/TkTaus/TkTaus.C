...
//============================================================================
{
  ...
  // std::cout << "=== TkTaus::InitOBjects()" << std::endl;
  return; 
}
...
//============================================================================
{
  ...
  for (int jentry = 0; jentry < nEntries; jentry++, nEvts++){
   ...
   // Fill MC-truth histos
    ...
    FillTurnOn_Numerator_(L1TkTaus_RelIsoTight , 25.0, hL1TkTaus_TurnOn25, hL1TkTaus_TurnOn25_1pr, hL1TkTaus_TurnOn25_3pr, hL1TkTaus_TurnOn25_withNeutrals, hL1TkTaus_TurnOn25_noNeutrals); 
    FillTurnOn_Numerator_(L1TkTaus_RelIsoTight , 50.0, hL1TkTaus_TurnOn50, hL1TkTaus_TurnOn50_1pr, hL1TkTaus_TurnOn50_3pr, hL1TkTaus_TurnOn50_withNeutrals, hL1TkTaus_TurnOn50_noNeutrals); 
    ...
    // Single-Tau 
    FillSingleTau_(L1TkTaus_RelIsoTight, hL1TkTaus_SingleTau_Rate  , hL1TkTaus_SingleTau_Eff);
    
    // Di-Tau
    FillDiTau_(L1TkTaus_RelIsoTight, hL1TkTaus_DiTau_Rate  , hL1TkTaus_DiTau_Eff);
  ...
  if (isMinBias) // new: speed things up a bit (Rate plots only make sense for Neutrino gun!)
    {
      ...
      // Single-Tau
      histoTools_.ConvertToRateHisto_1D( hL1TkTaus_SingleTau_Rate, N );
      
      // Di-Tau
      histoTools_.ConvertToRateHisto_1D( hL1TkTaus_DiTau_Rate, N );
  ...
  else // new: speed things up a bit
    {
      ...
      // Single-Tau
      FinaliseEffHisto_( hL1TkTaus_SingleTau_Eff, nEvtsWithMaxHTaus);
      
      // Di-Tau
      FinaliseEffHisto_( hL1TkTaus_DiTau_Eff    , nEvtsWithMaxHTaus);
  ...
  // Turn-ons for the best performing WP
  histoTools_.DivideHistos_1D(hL1TkTaus_TurnOn25, hMcHadronicTau_VisEt);
  histoTools_.DivideHistos_1D(hL1TkTaus_TurnOn25_1pr, hMcHadronicTau_VisEt_1pr);
  histoTools_.DivideHistos_1D(hL1TkTaus_TurnOn25_3pr, hMcHadronicTau_VisEt_3pr);
  histoTools_.DivideHistos_1D(hL1TkTaus_TurnOn25_withNeutrals, hMcHadronicTau_VisEt_withNeutrals);
  histoTools_.DivideHistos_1D(hL1TkTaus_TurnOn25_noNeutrals, hMcHadronicTau_VisEt_noNeutrals);

  histoTools_.DivideHistos_1D(hL1TkTaus_TurnOn50, hMcHadronicTau_VisEt);
  histoTools_.DivideHistos_1D(hL1TkTaus_TurnOn50_1pr, hMcHadronicTau_VisEt_1pr);
  histoTools_.DivideHistos_1D(hL1TkTaus_TurnOn50_3pr, hMcHadronicTau_VisEt_3pr);
  histoTools_.DivideHistos_1D(hL1TkTaus_TurnOn50_withNeutrals, hMcHadronicTau_VisEt_withNeutrals);
  histoTools_.DivideHistos_1D(hL1TkTaus_TurnOn50_noNeutrals, hMcHadronicTau_VisEt_noNeutrals);
...
//============================================================================
{
  ...
  // Resolutions 
  histoTools_.BookHisto_1D(hL1TkIsoTau_ResolutionEt    , "L1TkIsoTau_ResolutionEt"     , ";#delta E_{T} / E_{T}^{vis};Events / %.0f GeV", 2000, -1.0, +1.0);
  histoTools_.BookHisto_1D(hL1TkIsoTau_ResolutionEt_1pr, "L1TkIsoTau_ResolutionEt_1pr" , ";#delta E_{T} / E_{T}^{vis};Events / %.0f GeV", 2000, -1.0, +1.0);
  histoTools_.BookHisto_1D(hL1TkIsoTau_ResolutionEt_3pr, "L1TkIsoTau_ResolutionEt_3pr" , ";#delta E_{T} / E_{T}^{vis};Events / %.0f GeV", 2000, -1.0, +1.0);
  histoTools_.BookHisto_1D(hL1TkIsoTau_ResolutionEt_withNeutrals, "L1TkIsoTau_ResolutionEt_withNeutrals", ";#delta E_{T} / E_{T}^{vis};Events / %.0f GeV", 2000, -1.0, +1.0);
  histoTools_.BookHisto_1D(hL1TkIsoTau_ResolutionEt_noNeutrals  , "L1TkIsoTau_ResolutionEt_noNeutrals"  , ";#delta E_{T} / E_{T}^{vis};Events / %.0f GeV", 2000, -1.0, +1.0);

  histoTools_.BookHisto_1D(hL1TkIsoTau_ResolutionEta    , "L1TkIsoTau_ResolutionEta"    , ";#delta #eta / #eta^{vis};Events / %.2f", 2000, -1.0, +1.0);
  histoTools_.BookHisto_1D(hL1TkIsoTau_ResolutionEta_1pr, "L1TkIsoTau_ResolutionEta_1pr", ";#delta #eta / #eta^{vis};Events / %.2f", 2000, -1.0, +1.0);
  histoTools_.BookHisto_1D(hL1TkIsoTau_ResolutionEta_3pr, "L1TkIsoTau_ResolutionEta_3pr", ";#delta #eta / #eta^{vis};Events / %.2f", 2000, -1.0, +1.0);
  histoTools_.BookHisto_1D(hL1TkIsoTau_ResolutionEta_withNeutrals, "L1TkIsoTau_ResolutionEta_withNeutrals", ";#delta #eta / #eta^{vis};Events / %.2f", 2000, -1.0, +1.0);
  histoTools_.BookHisto_1D(hL1TkIsoTau_ResolutionEta_noNeutrals  , "L1TkIsoTau_ResolutionEta_noNeutrals"  , ";#delta #eta / #eta^{vis};Events / %.2f", 2000, -1.0, +1.0);

  histoTools_.BookHisto_1D(hL1TkIsoTau_ResolutionPhi    , "L1TkIsoTau_ResolutionPhi"    , ";#delta #phi / #phi^{vis};Events / %.2f rads", 2000, -1.0, +1.0);
  histoTools_.BookHisto_1D(hL1TkIsoTau_ResolutionPhi_1pr, "L1TkIsoTau_ResolutionPhi_1pr", ";#delta #phi / #phi^{vis};Events / %.2f rads", 2000, -1.0, +1.0);
  histoTools_.BookHisto_1D(hL1TkIsoTau_ResolutionPhi_3pr, "L1TkIsoTau_ResolutionPhi_3pr", ";#delta #phi / #phi^{vis};Events / %.2f rads", 2000, -1.0, +1.0);
  histoTools_.BookHisto_1D(hL1TkIsoTau_ResolutionPhi_withNeutrals, "L1TkIsoTau_ResolutionPhi_withNeutrals", ";#phi (rads);Events / %.2f rads", 2000, -1.0, +1.0);
  histoTools_.BookHisto_1D(hL1TkIsoTau_ResolutionPhi_noNeutrals  , "L1TkIsoTau_ResolutionPhi_noNeutrals"  , ";#phi (rads);Events / %.2f rads", 2000, -1.0, +1.0);

  histoTools_.BookHisto_1D(hL1TkIsoTau_ResolutionEt_C , "L1TkIsoTau_ResolutionEt_C" , ";E_{T} (GeV);Events / %.0f GeV" , 2000, -1.0, +1.0);
  histoTools_.BookHisto_1D(hL1TkIsoTau_ResolutionEta_C, "L1TkIsoTau_ResolutionEta_C", ";#eta;Events / %.2f"            , 2000, -1.0, +1.0);
  histoTools_.BookHisto_1D(hL1TkIsoTau_ResolutionPhi_C, "L1TkIsoTau_ResolutionPhi_C", ";#phi (rads);Events / %.2f rads", 2000, -1.0, +1.0);
  histoTools_.BookHisto_1D(hL1TkIsoTau_ResolutionEt_I , "L1TkIsoTau_ResolutionEt_I" , ";E_{T} (GeV);Events / %.0f GeV" , 2000, -1.0, +1.0);
  histoTools_.BookHisto_1D(hL1TkIsoTau_ResolutionEta_I, "L1TkIsoTau_ResolutionEta_I", ";#eta;Events / %.2f"            , 2000, -1.0, +1.0);
  histoTools_.BookHisto_1D(hL1TkIsoTau_ResolutionPhi_I, "L1TkIsoTau_ResolutionPhi_I", ";#phi (rads);Events / %.2f rads", 2000, -1.0, +1.0);
  histoTools_.BookHisto_1D(hL1TkIsoTau_ResolutionEt_F , "L1TkIsoTau_ResolutionEt_F" , ";E_{T} (GeV);Events / %.0f GeV" , 2000, -1.0, +1.0);
  histoTools_.BookHisto_1D(hL1TkIsoTau_ResolutionEta_F, "L1TkIsoTau_ResolutionEta_F", ";#eta;Events / %.2f"            , 2000, -1.0, +1.0);
  histoTools_.BookHisto_1D(hL1TkIsoTau_ResolutionPhi_F, "L1TkIsoTau_ResolutionPhi_F", ";#phi (rads);Events / %.2f rads", 2000, -1.0, +1.0);
  ...
  histoTools_.BookHisto_1D(hL1TkTaus_SingleTau_Rate, "L1TkTaus_SingleTau_Rate", "", nEt , minEt , maxEt );
  ...
  histoTools_.BookHisto_1D(hL1TkTaus_SingleTau_Eff, "L1TkTaus_SingleTau_Eff", "", nEt , minEt , maxEt );
  ...
  histoTools_.BookHisto_1D(hL1TkTaus_DiTau_Rate, "L1TkTaus_DiTau_Rate", "", nEt , minEt , maxEt );
  ...
  histoTools_.BookHisto_1D(hL1TkTaus_DiTau_Eff, "L1TkTaus_DiTau_Eff", "", nEt , minEt , maxEt );
  ...
  // Turn-ons for the best performing WP
  histoTools_.BookHisto_1D(hL1TkTaus_TurnOn25, "L1TkTaus_TurnOn25", "", 60 , minEt , maxEt );
  histoTools_.BookHisto_1D(hL1TkTaus_TurnOn25_1pr, "L1TkTaus_TurnOn25_1pr" , "", 60 , minEt , maxEt );
  histoTools_.BookHisto_1D(hL1TkTaus_TurnOn25_3pr, "L1TkTaus_TurnOn25_3pr" , "", 60 , minEt , maxEt );
  histoTools_.BookHisto_1D(hL1TkTaus_TurnOn25_withNeutrals, "L1TkTaus_TurnOn25_withNeutrals" , "", 60 , minEt , maxEt );
  histoTools_.BookHisto_1D(hL1TkTaus_TurnOn25_noNeutrals, "L1TkTaus_TurnOn25_noNeutrals" , "", 60 , minEt , maxEt );

  histoTools_.BookHisto_1D(hL1TkTaus_TurnOn50, "L1TkTaus_TurnOn50", "", 60 , minEt , maxEt );
  histoTools_.BookHisto_1D(hL1TkTaus_TurnOn50_1pr, "L1TkTaus_TurnOn50_1pr" , "", 60 , minEt , maxEt );
  histoTools_.BookHisto_1D(hL1TkTaus_TurnOn50_3pr, "L1TkTaus_TurnOn50_3pr" , "", 60 , minEt , maxEt );
  histoTools_.BookHisto_1D(hL1TkTaus_TurnOn50_withNeutrals, "L1TkTaus_TurnOn50_withNeutrals" , "", 60 , minEt , maxEt );
  histoTools_.BookHisto_1D(hL1TkTaus_TurnOn50_noNeutrals, "L1TkTaus_TurnOn50_noNeutrals" , "", 60 , minEt , maxEt );
...
//============================================================================
{
  ...
  hL1TkTaus_SingleTau_Rate->Write();
  ...
  // Turn-ons for the best performing WP
  hL1TkTaus_TurnOn25->Write();
  hL1TkTaus_TurnOn25_1pr->Write();
  hL1TkTaus_TurnOn25_3pr->Write();
  hL1TkTaus_TurnOn25_withNeutrals->Write();
  hL1TkTaus_TurnOn25_noNeutrals->Write();

  hL1TkTaus_TurnOn50->Write();
  hL1TkTaus_TurnOn50_1pr->Write();
  hL1TkTaus_TurnOn50_3pr->Write();
  hL1TkTaus_TurnOn50_withNeutrals->Write();
  hL1TkTaus_TurnOn50_noNeutrals->Write();
