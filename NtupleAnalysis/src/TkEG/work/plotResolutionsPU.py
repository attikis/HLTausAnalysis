...
def PlotHisto(datasetsMgr, h):
    ...
    if 0:
        ...
        p.setLegend(histograms.createLegend(0.68, 0.86-0.04*len(dsetsMgr.getAllDatasetNames()), 0.98, 0.92))
...
if __name__ == "__main__":
    ...
    if opts.saveDir == None:
        opts.saveDir = aux.getSaveDirPath(opts.mcrab, prefix="hltaus/TkEG/", postfix="ResolutionVsPU")
    else:
