...
{
   fLDCoefficients.push_back( -2.96732217997e-05 );
   fLDCoefficients.push_back( 0.00175983528917 );
   fLDCoefficients.push_back( 0.00490793918833 );
   fLDCoefficients.push_back( -0.00437386713001 );
   fLDCoefficients.push_back( -0.00078364087005 );
