...
int TMVAClassification_v6( TString myMethodList = "" )
{
   ...
   if (!gSystem->AccessPathName( sigFileName )) {
      sigInput = TFile::Open( sigFileName ); // check if file in local directory exists
   }
   else std::cout << "WARNING! Could not find file " << sigFileName << std::endl;

   if (!gSystem->AccessPathName( bkgFileName )) {
     bkgInput = TFile::Open( bkgFileName ); // check if file in local directory exists
   }
   else std::cout << "WARNING! Could not find file " << bkgFileName << std::endl;
   ...
   TTree *background     = (TTree*)bkgInput->Get("Raw2TTreeMaker/EvtTree");
   ...
   if(1)
    {
      dataloader->AddVariable("L1Tks_Pt"               , "L1Tks_Pt"               , "GeV/c",  'F');
      dataloader->AddVariable("L1Tks_Eta"              , "L1Tks_Eta"              , "",  'F');
      // dataloader->AddVariable("L1Tks_Phi"              , "L1Tks_Phi"              , "rads",  'F');
      // dataloader->AddVariable("L1Tks_Charge"           , "L1Tks_Charge"           , "e",  'F'); // gives error!
      // dataloader->AddVariable("L1Tks_POCAx"            , "L1Tks_POCAx"            , "cm",  'F');
      // dataloader->AddVariable("L1Tks_POCAy"            , "L1Tks_POCAy"            , "cm",  'F');
      dataloader->AddVariable("L1Tks_POCAz"            , "L1Tks_POCAz"            , "cm",  'F');
      dataloader->AddVariable("L1Tks_ChiSquared"       , "L1Tks_ChiSquared"       , "",  'F');
      // dataloader->AddVariable("L1Tks_StubPtConsistency", "L1Tks_StubPtConsistency", "",  'F');
      // dataloader->AddVariable("L1Tks_RInv"             , "L1Tks_RInv"             , "1/cm",  'F');
      // dataloader->AddVariable("L1Tks_IsGenuine"        , "L1Tks_IsGenuine"        , "",  'I');
      // dataloader->AddVariable("L1Tks_IsUnknown"        , "L1Tks_IsUnknown"        , "",  'I');
      // dataloader->AddVariable("L1Tks_IsCombinatoric"   , "L1Tks_IsCombinatoric"   , "",  'I');
      // dataloader->AddVariable("L1Tks_IsLoose"          , "L1Tks_IsLoose"          , "",  'I');
      // dataloader->AddVariable("L1Tks_IsFake"           , "L1Tks_IsFake"           , "",  'I');
      // dataloader->AddVariable("L1Tks_NStubs"           , "L1Tks_NStubs"           , "",  'I');
      // dataloader->AddVariable("L1Tks_NStubsPS"         , "L1Tks_NStubsPS"         , "",  'I');
      // dataloader->AddVariable("L1Tks_NStubsBarrel"     , "L1Tks_NStubsBarrel"     , "",  'I');
      // dataloader->AddVariable("L1Tks_NStubsEndcap"     , "L1Tks_NStubsEndcap"     , "",  'I');
      // dataloader->AddVariable("L1Tks_TP_Index"         , "L1Tks_TP_Index"         , "",  'I');

      // You can add so-called "Spectator variables", which are not used in the MVA training,
      // but will appear in the final "TestTree" produced by TMVA. This TestTree will contain the
      // input variables, the response values of all trained MVAs, and the spectator variables
      // dataloader->AddSpectator("spec1 := L1Tks_IsLoose", "L1Tks_IsLoose (Spectator 1)", "",  'I');
    }
