...

{
  ...
  if(1)
    {
      factory->AddVariable("L1Tks_Pt"               , "L1Tks_Pt"               , "GeV/c",  'F');
      factory->AddVariable("L1Tks_Eta"              , "L1Tks_Eta"              , "",  'F');
      // factory->AddVariable("L1Tks_Phi"              , "L1Tks_Phi"              , "rads",  'F');
      factory->AddVariable("L1Tks_Charge"           , "L1Tks_Charge"           , "e",  'F');
      // factory->AddVariable("L1Tks_POCAx"            , "L1Tks_POCAx"            , "cm",  'F');
      // factory->AddVariable("L1Tks_POCAy"            , "L1Tks_POCAy"            , "cm",  'F');
      factory->AddVariable("L1Tks_POCAz"            , "L1Tks_POCAz"            , "cm",  'F');
      factory->AddVariable("L1Tks_ChiSquared"       , "L1Tks_ChiSquared"       , "",  'F');
      // factory->AddVariable("L1Tks_StubPtConsistency", "L1Tks_StubPtConsistency", "",  'F');
      // factory->AddVariable("L1Tks_RInv"             , "L1Tks_RInv"             , "1/cm",  'F');
      // factory->AddVariable("L1Tks_IsGenuine"        , "L1Tks_IsGenuine"        , "",  'I');
      // factory->AddVariable("L1Tks_IsUnknown"        , "L1Tks_IsUnknown"        , "",  'I');
      // factory->AddVariable("L1Tks_IsCombinatoric"   , "L1Tks_IsCombinatoric"   , "",  'I');
      // factory->AddVariable("L1Tks_IsLoose"          , "L1Tks_IsLoose"          , "",  'I');
      // factory->AddVariable("L1Tks_IsFake"           , "L1Tks_IsFake"           , "",  'I');
      // factory->AddVariable("L1Tks_NStubs"           , "L1Tks_NStubs"           , "",  'I');
      // factory->AddVariable("L1Tks_NStubsPS"         , "L1Tks_NStubsPS"         , "",  'I');
      // factory->AddVariable("L1Tks_NStubsBarrel"     , "L1Tks_NStubsBarrel"     , "",  'I');
      // factory->AddVariable("L1Tks_NStubsEndcap"     , "L1Tks_NStubsEndcap"     , "",  'I');
      // factory->AddVariable("L1Tks_TP_Index"         , "L1Tks_TP_Index"         , "",  'I');
    }
  ...
  // TString bkgFileName = "/afs/cern.ch/user/a/attikis/scratch0/CMSSW_9_2_0/src/L1Trigger/L1TCommon/test/raw2TTree.root";
  ...
  TTree *signal     = (TTree*)sigFile->Get("Raw2TTreeMaker/EvtTree");
  TTree *background = (TTree*)bkgFile->Get("Raw2TTreeMaker/EvtTree");
  ...
  if (Use["BDTG"]) // Gradient Boost
    factory->BookMethod( TMVA::Types::kBDT, "BDTG",
			 "H:!V:NTrees=1000:MaxDepth=3:BoostType=Grad:Shrinkage=0.10:UseBaggedBoost:BaggedSampleFraction=0.5" );
  ...
  if (Use["BDT"])  // Adaptive Boost
    factory->BookMethod( TMVA::Types::kBDT, "BDT",
			 "H:!V:NTrees=850:MaxDepth=3:BoostType=AdaBoost:AdaBoostBeta=0.5:SeparationType=GiniIndex:nCuts=20:IgnoreNegWeightsInTraining=True" );
  // "H:!V:NTrees=850:MaxDepth=3:BoostType=AdaBoost:AdaBoostBeta=0.5:UseBaggedBoost:BaggedSampleFraction=0.5:SeparationType=GiniIndex:nCuts=20:IgnoreNegWeightsInTraining=True" );
  ...
  if (0) if (!gROOT->IsBatch()) TMVAGui( outfileName );
}
