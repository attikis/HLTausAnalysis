//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
// Usage:
// .x runTauTrigger.cc(<multicrab_dir>, <sample_alias>, <text_to_append_to_output>, <numberOfEvents>);
//
// Example-1:
// root -l
// root[0] .x runTauTrigger.cc("L1PixTks_CandPixHits_TPs_GenPs_NPixHitsMin3_rphi3mm_rz5mm_TTI2023Upg14D_24Jul2015_154331", "VBF", "", -1);
// (Run on all events to produce the file "TauTrigger_Histograms_VBF.root")
//
// Example-2:
// root -l
...
// (Run on 10 events to produce the file "TauTrigger_Histograms_VBF_alex.root")
//
...
//
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
void runTauTrigger(const std::string MulticrabDir = "", 
		   const std::string SampleName = "", 
		   const std::string text = "", 
		   const int maxEvents = -1)
{

  gSystem->CompileMacro("TauTrigger.C");
  ...
  TauTrigger macro(absolutePath + "/" + MulticrabDir, SampleName, text, maxEvents);
  macro.Loop();
}
